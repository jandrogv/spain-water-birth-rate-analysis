...
```{r}
Poblacion <- read_excel(here::here("data", "raw", "Poblacion_España.xls"))

Migraciones_internas <- read_excel(here::here("data", "raw", "Migracion_interna.xls"))

Migracion_externa_entrada <- read_excel(here::here("data", "raw", "Migracion_externa_entrada.xls"))

Migracion_externa_salida <- read_excel(here::here("data", "raw", "Migracion_externa_salida.xls"))

Natalidad <- read_excel(here::here("data", "raw", "Natalidad.xls"))

Mortalidad <- read_excel(here::here("data", "raw", "Mortalidad.xls"))

Extension_territorial_Provincias <- read_excel(here::here("data", "raw", "Extension territorial Provincias.xlsx"),
    sheet = "Provincias")

Provincias_Comunidad <- read_excel(here::here("data", "raw", "Provincias_Comunidad.xlsx"))

Poblacion_Edad <- read_excel(here::here("data", "raw", "Poblacion_Edad.xls"))
```
...
```{r}
write.xlsx(Poblacion, here::here("data", "processed", "Poblacion_Provincias.xlsx"), sheetName = "Poblacion_Provincias")
...
```{r}
write.xlsx(Poblacion_Edad, here::here("data", "processed", "Poblacion_Edad.xlsx"), sheetName = "Poblacion_Edad")
...
```{r}
write.xlsx(Poblacion_Comunidades, here::here("data", "processed", "Poblacion_Comunidades.xlsx"), sheetName = "Poblacion_Comunidades")
...
```{r}
Agua_disponible <- read_excel(here::here("data", "raw", "Agua_disponible.xls"))

Volumen_de_agua <- read_excel(here::here("data", "raw", "Volumen de agua.xls"))

Distribución_de_agua <- read_excel(here::here("data", "raw", "Distribución de agua.xls"))

Extension_territorial_Comunidades <- read_excel(here::here("data", "raw", "Extension territorial Provincias.xlsx"),
    sheet = "Comunidades Autonomas")

Poblacion_Comunidad <- read_excel(here::here("data", "raw", "Poblacion_Comunidad.xls"))
```
...
```
```{r}
write.xlsx(Tabla_Final, here::here("data", "processed", "Tabla_Final.xlsx"), sheetName = "Tabla_Final")
```


```{r}
write.xlsx(Agua_España, here::here("data", "processed", "Agua_España.xlsx"), sheetName = "Agua_España")
